...
class HallSettingsSheet extends StatefulWidget {
  const HallSettingsSheet({
    super.key,
  ...
  static Future<void> show(
    ...
    return AppBottomSheet.show(
      context,
      title: LocaleKeys.hall_settingsTitle.tr(),
      child: HallSettingsSheet(
  ...
  @override
  State<HallSettingsSheet> createState() => _HallSettingsSheetState();
}

class _HallSettingsSheetState extends State<HallSettingsSheet> {
  late int _columns;
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        AppText(
          LocaleKeys.hall_columnsPerRow.tr(),
          fontSize: 14,
